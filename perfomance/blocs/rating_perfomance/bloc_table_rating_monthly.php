<form id="form1" name="form1" method="post">
  ...
  <tbody>
    <tr>
      ...
      <td class="table_item_header" width="13%">Result Description</td>
      <td class="table_item_header" width="17%">Achieved (√) or Not (x)</td>
      <td class="table_item_header" width="17%">Achieve Monthly Performance Assesment Agreement </td>
    </tr>
    <tr>
