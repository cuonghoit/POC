            ...
            <div class="card">
               <!--  <div class="card-header">Training Management / Training-implementation</div> -->
                ...
                <div class="card-body">
                    ...
                    <h3 class="text-center" ><b>DEPARTMENT MONTHLY PERFORMANCE REPORT - FILTER BY LEVELS</b></h3><br>
                    <table>
                        <tr>
                            <div class="form-group">
                                <td class="text-right"><b>Department:</b></td>
                                <td><select class="form-control col-md-12">
                                ...
                                <td><select class="form-control col-md-12">
                                    <option value="1">excellen</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                                </select></td>
                            </div>
