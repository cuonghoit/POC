        ...
        <div style="width: 100%;">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h3 class="text-center" ><b>EMPLOYEE MULTI-MONTHLY PERFORMANCE REPORT -FILTER BY LEVELS</b></h3><br>
                    ...
                    <table style="width: 100%;">
                        ...
                        <tr>
                            <td><p class="text-left" ><b>RECORDING MONTHLY RATES & PERFORMANCE APPRAISAL LEVELS</b></p></td>
                            <div class="form-group">
                        ...
                        <tr>
                            <div class="form-group">
                                <td class="text-right"><b>From Month/Year</b></td>
                                <td><input type="text" name="year" class="form-control col-md-10" value="" placeholder="1/2018"></td>
                                <td class="text-right"><b>To Month/Year</b></td>
                                <td><input type="text" name="year" class="form-control col-md-10" value="" placeholder="1/2019"></td>
                    ...
                    <div class="table-responsive Training">
                        <table class="table table-bordered text-center table-striped" id="dtHorizontalExample" >
                            <tr>
                                ...
                                <th colspan="7">Rating MSC Monthly Objectives (Achieved or Not)</th>
