        ...
        <div style="width: 100%;">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h3 class="text-center" ><b>MY ANNUAL PERFORMANCE REPORT</b></h3><br>
                    ...
                    <div class="table-responsive Training">
                        <table class="table table-bordered text-center table-striped" id="dtHorizontalExample" >
                            ...
                            <tr>
                                <th colspan="8" class="text-right">Annual Average Rate:</th>
                                <td></td>
                                <td></td>
                            </tr>
                            <tr>
                                <th colspan="8" class="text-right">Convert to Annual Performance Appraisal Level:</th>
                                <td></td>
                                <td></td>
                            </tr>
                        </table>
