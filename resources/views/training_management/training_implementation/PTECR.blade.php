        ...
        <div style="width: 100%;">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h3 class="text-center" ><b>COMBINED POST TRAINING EVALUATION</b></h3><br>
                    <table style="width: 100%;">
                        <tr>
                            <div class="form-group">
                                <td><label for="trainingEvent">Training event:
                                </label></td>
                                <td><input type="text" class="form-control col-md-10" name="trainingEvent" value=""><td></td>
                            </div>
                            <div class="form-group">
                                <td><label for="trainingCenter">Training center:
                                </label></td>
                                <td><input type="text" class="form-control col-md-10" name="trainingCenter" value="" ><td></td>
                            </div>
                        </tr>
                        <tr>
                            <div class="form-group">
                                <td><label for="dateOfEvent">Date of event:
                                </label></td>
                                <td><input type="text" class="form-control col-md-10" name="dateOfEvent" value="" ><td></td>
                            </div>
                            <div class="form-group">
                                <td><label for="dateCompletingEvaluation">Date completing evaluation:
                                </label></td>
                                <td><input type="text" class="form-control col-md-10" name="dateCompletingEvaluation" value="" ><td></td>
                            </div>
                        </tr>
                        <tr>
                            <div class="form-group">
                                <td><label for="participantNumber">Participant number:
                                </label></td>
                                <td><input type="email" class="form-control col-md-10" name="participantNumber" value="" ><td></td>
                            </div>
                            <div class="form-group">
                                <td><label for="nameOfTrainer">Name of trainer:
                                </label></td>
                                <td><input type="text" class="form-control col-md-10" name="nameOfTrainer" value="" ><td></td>
                            </div>
                        </tr>
                    </table><br>
                        <input type="hidden" name="_token" value="{{csrf_token()}}">
                        <p class="text-left" ><b>AVERAGE TRAINING EVALUATION:</b></p>
